...
namespace Sirenix.OdinInspector.Editor
{
    ...
    internal static class UnityPropertyHandlerUtility
    {
        ...
        static UnityPropertyHandlerUtility ()
        {
            ...
            var onGUIMethod = PropertyHandler.GetMethod (PropertyHandler_OnGUIName, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static | BindingFlags.SuppressChangeType | BindingFlags.InvokeMethod);
